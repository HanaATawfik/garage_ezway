import 'package:flutter/material.dart';
                                        ...
                                        import 'active_session.dart'; // Added this import

                                        class BookSlotCfc extends StatefulWidget {
                                          const BookSlotCfc({super.key});

                                          @override
                                          _BookSlotCfcState createState() => _BookSlotCfcState();
                                        }

                                        class _BookSlotCfcState extends State<BookSlotCfc> {
                                          int currentFloor = 1;
                                          String? selectedSlotId;
                                          int? selectedFloor;

                                          // First floor spaces - 4 slots with varied statuses
                                          ...
                                          // Second floor spaces - 6 slots with varied statuses
                                          final List<Map<String, dynamic>> secondFloorSpaces = [
                                            ...
                                            {"id": "D5", "status": "Occupied", "row": "D"},
                                            {"id": "D6", "status": "Reserved", "row": "D"},
                                          ];
