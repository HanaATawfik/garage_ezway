import 'package:flutter/material.dart';
        ...
        // Vertical parking column - with increased size
        ...
        // Individual parking slot - with increased size
        class _ParkingSlot extends StatelessWidget {
          ...
          Widget build(BuildContext context) {
            ...
            if (status == 'Available') {
              // Available slots show an outline car icon
              slotIcon = Icon(
              ...
              // Selected slots show a filled car icon in green with highlighted background
              slotIcon = Icon(
              ...
              // Occupied slots show filled car icon in red
              slotIcon = Icon(
                Icons.directions_car,
                color: Colors.red,
                size: 50, // Increased icon size
              ...
              // Reserved slots show filled car icon in gray
              slotIcon = Icon(
                Icons.directions_car,
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                margin: EdgeInsets.symmetric(vertical: 6), // Added margin for spacing
                decoration: BoxDecoration(
                  color: backgroundColor,
                  border: border,
