import 'package:flutter/material.dart';
                                            ...
                                            class _BookSlotCSPageState extends State<BookSlotCSPage> {
                                              ...
                                              final List<Map<String, dynamic>> firstFloorSpaces = [
                                                ...
                                                {"id": "A2", "status": "Occupied", "row": "A"},  // Changed from Reserved to Occupied
                                                {"id": "A3", "status": "Reserved", "row": "A"},  // Changed from Occupied to Reserved
                                              ];

                                              // Second floor spaces - 2 slots with varied statuses
                                              final List<Map<String, dynamic>> secondFloorSpaces = [
                                                {"id": "D1", "status": "Available", "row": "D"},  // Changed from Available to Reserved
                                                {"id": "D2", "status": "Available", "row": "D"}, // Changed from Available to Reserved
                                              ];
